        ...
        <nav>
            <ul>
                ...
                <li><a href="/seller-order"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        Orders</a></li>
                <li class="active"><a href="/seller-product"><svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="content">
        ...
        <div class="form">
            <form action="#" method="post" enctype="multipart/form-data">
                <div class="title">
                    <h4>Title</h3>
                        ...
                        <h4>Short Description</h3>
                            <textarea name="short-des" id="short-des" cols="30" rows="10"><?php echo $product['short_des'] ?></textarea>
                            <h4>Description</h4>
                            <textarea name="des" id="des" cols="30" rows="10"><?php echo $product['des'] ?></textarea>
                </div>
                ...
                <div class="extra">
                    <h4>product type</h4>
                    <input type="text" name="product_type" value="<?php echo $product['product_type'] ?>">
                    <h4>Vendor</h4>
                    <input type="text" name="vendor" value="<?php echo $product['vendor'] ?>">
                    <h4>Brand</h4>
