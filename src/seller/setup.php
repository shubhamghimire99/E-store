<?php 
    ...
    $verify_url = "SELECT * FROM seller_details WHERE id = '$seller_id'";
    $verify = mysqli_query($conn, $verify_url);
    $fetch_sellers = mysqli_fetch_assoc($verify);
    if($fetch_sellers){
        header("location: /seller-update");
    }else{
        echo "<script>alert('You have to setup your store')</script>";
    }

    // check if seller exists in the database and if it does, redirect to setup-update.php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO  seller_details (`store_name`,`id`,`citizenship`, `PAN`, `certificate`) VALUES ('$store_name','$seller_id','$file_name', '$pan', '$file2_name')";
     ...
     <div class="container">
        ...
        <div class="wrapper">
            <div class="menubar">
                <ul>
                    <li><a href="/seller-profile">
                            ...
                            General</a></li>
                    <li class="active"><a href="/seller-setup"><svg xmlns="http://www.w3.org/2000/svg" width="1.4em" height="1.4em" viewBox="0 0 24 24">
            ...
            <div class="content">
                ...
                <form action="" method="post" class="details" enctype="multipart/form-data">
                    <div class="store">
                        <p>Name your store</p>
                    ...
                    <div class="citizenship">
                        ...
                        <input type="file" name="citizenship" id="citizenship" hidden required>
                        <label for="citizenship">Upload</label>
                    </div>
                    <hr>
                    <div class="pan">
                    ...
                    <div class="certificate">
                        ...
                        <input type="file" name="certificate" id="certificate" hidden required>
                        <label for="certificate">Upload</label>
                    </div>
                    <hr>
