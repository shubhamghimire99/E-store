...
$sql = "select * from `seller_details` where id = '$seller_id'";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($result);
$imagename = $row['citizenship'];
$imagepath = "/src/images/" . $imagename;
$imagename2 = $row['certificate'];
$imagepath2 = "/src/images/" . $imagename2;
                ...
                <div class="box">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="details">
                        ...
                        <div class="pan">
                            ...
                            <input type="text" name="PAN" value="<?php
                                                                    if ($row['PAN'] != "") {
                                                                        echo $row['PAN'];
                                                                    } ?>" required>
                        </div>
