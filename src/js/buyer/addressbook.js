...
function editAddress(id) {
  ...
  document.getElementById("edit-state").value = address.province;
  populateCities();
  document.getElementById("edit-city").value = address.city;
  populateAreas();
  document.getElementById("edit-area").value = address.area;

  // document.getElementById("edit-state").option = address.state;
  document.getElementById("edit-address").value = address.address;
  document.getElementById("edit-landmark").value = address.Landmark;

  if(address.effectivedelivery == "Office"){
    document.getElementById("value-4").checked = true;
  } else {
    document.getElementById("value-3").checked = true;
  }
  // document.getElementById("value-3").value = address.effectivedelivery;
